    ...
    public static double[] Probability_check(Scanner in){
        ...
        while (true){
            try {
                ...
                String alert = ColorPrint.redString("Not valid settings, input from beginning again. Each Probability should be between(0.1-0.8). " +
                        "In total should not exceed 0.9");
